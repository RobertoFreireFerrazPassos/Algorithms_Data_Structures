...
namespace Benchmark.Benchmarks
{
    /*
            ...
            |--------------------------------- |----------:|----------:|----------:|
            |  AccessingArrayIndex_SimpleInput | 0.2901 ns | 0.0097 ns | 0.0086 ns |
            | AccessingArrayIndex_ComplexInput | 0.0192 ns | 0.0052 ns | 0.0046 ns |
    */
    public class BigONotationBenchmark
    {
        ...
        private string simpleText1 = "Lorem Ipsum is simply dummy text of the printing and typesetting";

        private string simpleText2 = "Lorem Ipsum is simply dummy text of the printing and typestting";
